        ...
        <flux:sidebar sticky stashable class="border-r border-primary-100 bg-white dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group heading="Menu" class="grid">
                    ...
                    <flux:navlist.item icon="bell" :href="route('customer.notifications')" :current="request()->routeIs('customer.notifications')" wire:navigate>Notifications</flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
