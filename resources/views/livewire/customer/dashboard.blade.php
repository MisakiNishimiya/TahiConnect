...
new #[Layout('components.layouts.app')] class extends Component {
    public function with(): array
    {
        ...
        return [
            ...
            'recentOrders' => Order::where('user_id', $user->id)->with(['garmentType', 'preMadeProduct'])->latest()->take(5)->get(),
            'recentActivities' => ActivityLog::where('user_id', $user->id)->latest()->take(5)->get(),
            'upcomingAppointmentsList' => Appointment::where('user_id', $user->id)->where('date', '>=', now()->toDateString())->orderBy('date')->take(3)->get(),
        ];
    }
}; ?>
    ...
    <div class="tc-card">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div class="flex flex-col items-center text-center group">
                <a href="{{ route('customer.catalog') }}" wire:navigate class="flex flex-col items-center gap-3 w-full">
                    <div class="w-16 h-16 rounded-full bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-200 dark:border-blue-800 flex items-center justify-center group-hover:border-blue-400 group-hover:bg-blue-100 transition-colors">
                        <svg class="w-7 h-7 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                        </svg>
                    </div>
                    <span class="w-full py-2 px-3 text-sm font-medium text-blue-600 bg-blue-50 dark:bg-blue-900/20 rounded-lg group-hover:bg-blue-100 dark:group-hover:bg-blue-900/30 transition-colors">
                        Our Catalog
                    </span>
                </a>
            </div>
            ...
            <!-- New Order -->
            <div class="flex flex-col items-center text-center group">
                <a href="{{ route('customer.orders') }}" wire:navigate class="flex flex-col items-center gap-3 w-full">
                    <div class="w-16 h-16 rounded-full bg-emerald-50 dark:bg-emerald-900/20 border-2 border-emerald-400 flex items-center justify-center group-hover:bg-emerald-100 group-hover:border-emerald-500 transition-colors">
                        <svg class="w-7 h-7 text-emerald-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.5v15m7.5-7.5h-15"/>
                        </svg>
                    </div>
                    <span class="w-full py-2 px-3 text-sm font-medium text-white bg-emerald-600 rounded-lg group-hover:bg-emerald-700 transition-colors">
                        New Order
                    </span>
                </a>
            </div>
            ...
            <!-- Measurements -->
            <div class="flex flex-col items-center text-center group">
                <a href="{{ route('customer.measurements') }}" wire:navigate class="flex flex-col items-center gap-3 w-full">
                    <div class="w-16 h-16 rounded-full bg-purple-50 dark:bg-purple-900/20 border-2 border-purple-200 dark:border-purple-800 flex items-center justify-center group-hover:border-purple-400 group-hover:bg-purple-100 transition-colors">
                    ...
                    <span class="w-full py-2 px-3 text-sm font-medium text-purple-600 bg-purple-50 dark:bg-purple-900/20 rounded-lg group-hover:bg-purple-100 dark:group-hover:bg-purple-900/30 transition-colors">
                        My Measurements
                    </span>
                </a>
            </div>
            ...
            <!-- Appointments -->
            <div class="flex flex-col items-center text-center group">
                <a href="{{ route('customer.appointments') }}" wire:navigate class="flex flex-col items-center gap-3 w-full">
                    <div class="w-16 h-16 rounded-full bg-amber-50 dark:bg-amber-900/20 border-2 border-amber-200 dark:border-amber-800 flex items-center justify-center group-hover:border-amber-400 group-hover:bg-amber-100 transition-colors">
                    ...
                    <span class="w-full py-2 px-3 text-sm font-medium text-amber-600 bg-amber-50 dark:bg-amber-900/20 rounded-lg group-hover:bg-amber-100 dark:group-hover:bg-amber-900/30 transition-colors">
                        My Appointments
                    </span>
                </a>
            </div>
