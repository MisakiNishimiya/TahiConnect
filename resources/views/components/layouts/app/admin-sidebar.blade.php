        ...
        <flux:sidebar sticky stashable class="border-r border-primary-100 bg-white dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group heading="Administration" class="grid">
                    ...
                    <flux:navlist.item icon="banknotes" :href="route('admin.payments')" :current="request()->routeIs('admin.payments')" wire:navigate>Payments</flux:navlist.item>
                    <flux:navlist.item icon="document-chart-bar" :href="route('admin.reports')" :current="request()->routeIs('admin.reports')" wire:navigate>Reports</flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
                        ...
                        <div class="p-0 text-sm font-normal">
                            <div class="flex items-center gap-2 px-1 py-1.5 text-left text-sm">
                                ...
                                <div class="grid flex-1 text-left text-sm leading-tight">
                                    ...
                                    <span class="truncate text-xs text-zinc-500">Admin</span>
                                </div>
                            </div>
                        </div>
                    </flux:menu.radio.group>
