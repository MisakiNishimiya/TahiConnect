...
<div class="flex flex-col gap-6">
    <x-auth-header title="Welcome back" description="Sign in to your TahiConnect account" />
    ...
    <form wire:submit="login" class="flex flex-col gap-6">
        ...
        <div class="flex items-center justify-end">
            <flux:button variant="primary" type="submit" class="w-full !bg-primary-500 hover:!bg-primary-600">{{ __('Log in') }}</flux:button>
        </div>
    </form>
