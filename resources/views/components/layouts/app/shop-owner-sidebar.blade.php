        ...
        <flux:sidebar sticky stashable class="border-r border-primary-100 bg-white dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <div class="flex items-center gap-2 px-2 pb-4 pt-2">
                ...
                <div>
                    ...
                    <p class="text-[10px] text-zinc-500 font-medium uppercase tracking-wider leading-none mt-0.5">Shop Owner</p>
                </div>
            </div>
            ...
            <flux:navlist variant="outline">
                ...
                <flux:navlist.group heading="Overview" class="grid">
                    <flux:navlist.item icon="home" :href="route('shopowner.dashboard')" :current="request()->routeIs('shopowner.dashboard')" wire:navigate>
                        Dashboard
                    </flux:navlist.item>
                </flux:navlist.group>
                ...
                <flux:navlist.group heading="Operations" class="grid">
                    ...
                    <flux:navlist.item icon="calendar" :href="route('shopowner.appointments')" :current="request()->routeIs('shopowner.appointments')" wire:navigate>
                        Appointments
                    </flux:navlist.item>

                    <flux:navlist.item icon="banknotes" :href="route('shopowner.payments')" :current="request()->routeIs('shopowner.payments')" wire:navigate>
                        Payments
                    </flux:navlist.item>
                </flux:navlist.group>
                ...
                <flux:navlist.group heading="Management" class="grid">
                    <flux:navlist.item icon="users" :href="route('shopowner.staff')" :current="request()->routeIs('shopowner.staff')" wire:navigate>
                        Staff
                    </flux:navlist.item>

                    <flux:navlist.item icon="user-group" :href="route('shopowner.customers')" :current="request()->routeIs('shopowner.customers')" wire:navigate>
                        Customers
                    </flux:navlist.item>

                    <flux:navlist.item icon="swatch" :href="route('shopowner.garments')" :current="request()->routeIs('shopowner.garments')" wire:navigate>
                        Pre-Made Catalog
                    </flux:navlist.item>

                    <flux:navlist.item icon="tag" :href="route('shopowner.rates')" :current="request()->routeIs('shopowner.rates')" wire:navigate>
                        Rates & Fabrics
                    </flux:navlist.item>
                </flux:navlist.group>
                ...
                <flux:navlist.group heading="Analytics" class="grid">
                    <flux:navlist.item icon="document-chart-bar" :href="route('shopowner.reports')" :current="request()->routeIs('shopowner.reports')" wire:navigate>
                        Reports & Analytics
                    </flux:navlist.item>

                    <flux:navlist.item icon="credit-card" :href="route('shopowner.subscription')" :current="request()->routeIs('shopowner.subscription')" wire:navigate>
                        My Subscription
                    </flux:navlist.item>

                    <flux:navlist.item icon="cog-6-tooth" :href="route('shopowner.settings')" :current="request()->routeIs('shopowner.settings')" wire:navigate>
                        Business Settings
                    </flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
        ...
        <nav class="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white dark:bg-zinc-900 border-t border-zinc-200 dark:border-zinc-700 safe-bottom shadow-lg">
            <div class="grid grid-cols-5 gap-0">
                <a href="{{ route('shopowner.dashboard') }}" wire:navigate
                    ...
                    <svg class="w-5 h-5 mb-1" fill="{{ request()->routeIs('shopowner.dashboard') ? 'currentColor' : 'none' }}" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <a href="{{ route('shopowner.orders') }}" wire:navigate
                    ...
                    <div class="relative mb-1">
                        <svg class="w-5 h-5" fill="{{ request()->routeIs('shopowner.orders') ? 'currentColor' : 'none' }}" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25z"/>
                        </svg>
                        @if($pendingOrders > 0)
                ...
                <a href="{{ route('shopowner.staff') }}" wire:navigate
                    ...
                    <svg class="w-5 h-5 mb-1" fill="{{ request()->routeIs('shopowner.staff') ? 'currentColor' : 'none' }}" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <a href="{{ route('shopowner.garments') }}" wire:navigate
                    ...
                    <svg class="w-5 h-5 mb-1" fill="{{ request()->routeIs('shopowner.garments') ? 'currentColor' : 'none' }}" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <a href="{{ route('shopowner.settings') }}" wire:navigate
                    ...
                    <svg class="w-5 h-5 mb-1" fill="{{ request()->routeIs('shopowner.settings') ? 'currentColor' : 'none' }}" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
